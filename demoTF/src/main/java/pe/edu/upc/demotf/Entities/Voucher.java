...
public class Voucher {
    ...
    public Voucher(int idVoucher, LocalDate dateVoucher, LocalDateTime hourVoucher, int destinationAccountVoucher, double amountVoucher, int numberOperationVoucher) {
